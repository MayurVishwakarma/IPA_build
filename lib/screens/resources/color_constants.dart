...
class ColorConstant {
  ...
  static Color lightGrey=const Color.fromARGB(255, 216, 216, 216);

  static Color transparent = Colors.transparent;

  static Color mintGreen = fromHex("#3EB489");

  static Color lightBlue700 = fromHex('#148fbd');
  
  static Color royaleBlue = fromHex("#246EE9");
  ...
  static Color purpleNew = fromHex("#905fd0");

  static Color blueIris = fromHex("#4120a9");

  static Color neonGreen = fromHex("#ade292");

  static Color indigo = fromHex("#3e004a");
  static Color pastalRed =fromHex('#ff4e4e');
